...
#else //else de SO_LIBRARIES - WINDOWS
...
#ifndef WIN64//IS NOT WINDOWS - 64
...
#define EOPNOTSUPP WSAEOPNOTSUPP
#define EWOULDBLOCK WSAEWOULDBLOCK
#endif//IS NOT WINDOWS - 64

#ifdef USE_SNPRINTF //IT USES SPRINTF
#ifdef MAIN //HAS MAIN
...
#ifdef windows //initsocks definition - WINDOWS
...
#else //UNIX doesnt need it

/* no stupid stuff necessary for unix */
#define initsocks()
#define donesocks()

#endif //initsocks definition

#ifdef SOCK_ERRORS //IS USED SOCK_ERRORS
...
#ifdef RSERVE_PKG /* use error instead of exit */ //has rserve pkg
...
#endif //IS USED SOCK_ERRORS

//BUILD SIN DATA STRUCT
